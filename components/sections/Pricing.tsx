...
export function Pricing() {
  return (
    <section className="bg-[#F7F8FA] py-20 border-b border-[#E2E8F0]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h2 className="text-[38px] font-extrabold text-[#0B1422] tracking-tight leading-tight">
              Монтаж корта{" "}
              <span className="text-[#718096] font-medium text-[28px]">
                (на подготовленный фундамент)
              </span>
            </h2>
          </div>
          <Button className="bg-[#1B54B4] hover:bg-[#1648a0] text-white font-bold rounded-xl h-11 px-6 text-[14px] shadow-none gap-2 transition-colors duration-150 shrink-0">
            Заказать монтаж
