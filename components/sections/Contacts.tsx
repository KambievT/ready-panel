...
export function Contacts() {
  return (
    <section className="relative bg-gradient-to-b from-[#F7F9FC] to-white py-16 md:py-20 lg:py-24 border-b border-[#E2E8F0]">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-[14px] text-[#0B1422] leading-snug">
          ...
          {/* Messengers — full width */}
          <div className="md:col-span-2 bg-white rounded-2xl border border-[#E2E8F0] p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-[#29ABE2]/10 hover:bg-[#29ABE2] text-[#29ABE2] hover:text-white rounded-xl px-5 py-3 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-[#25D366]/10 hover:bg-[#25D366] text-[#25D366] hover:text-white rounded-xl px-5 py-3 transition-colors"
              >
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-[#168ACD]/10 hover:bg-[#168ACD] text-[#168ACD] hover:text-white rounded-xl px-5 py-3 transition-colors"
              >
                <Image
                ...
                />
                <span className="text-[14px] font-semibold">MAX</span>
              </a>
            </div>
          </div>
        </div>
